"""notion_bridge - Bridge bidireccional entre Orca y la API de Notion.
...
Uso tipico desde un agente de Orca:
    ...
    from notion_bridge import NotionBridgeService, NotionBridgeConfig
    from notion_bridge.client import NotionClient
    from notion_bridge.transformer import NotionTransformer
